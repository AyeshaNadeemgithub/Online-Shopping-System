...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 300, 30));
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 300, 30));
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 300, 30));
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 410, 300, 30));

        jTextField5.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, 300, 30));

        jTextField6.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 530, 300, 30));
        ...
        jPanel1.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 590, 300, 30));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 640, 140, 40));
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 640, 140, 40));
        ...
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 300, 30));
    ...
    public boolean isValidPassword(String password) {
        // At least 8 chars, one letter, one digit, one special char
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (isEmpty()) {
            ...
            if (user.isEmailExist(email)) {
                JOptionPane.showMessageDialog(this, "This email address already exists", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            }

            if (!isValidPassword(password)) {
                JOptionPane.showMessageDialog(this,
                        "Password must be at least 8 characters long and include letters, digits, and special characters.",
                        "Invalid Password",
            ...
            // If all checks pass, insert user
    ...
    private void jTextField4KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField4KeyTyped
        ...
        if (!Character.isDigit(input) && input != '\b') {
            ...
            JOptionPane.showMessageDialog(this, "Only numbers are allowed in phone number!", "Warning", 2);
        }
